      ...
      <View style={styles.modalBackground}>
        <View style={styles.modalContent}>
          ...
          <Text style={styles.modalText}>
            How can we assist you? Here you can find answers to frequently asked questions.
          </Text>

          {/* Container Ikon Sosial */}
          <View style={styles.iconContainer}>
            {/* Instagram Link Icon */}
            <TouchableOpacity onPress={() => Linking.openURL('https://www.instagram.com/cpslaboratory/')}>
              <Image
            ...
            {/* OA Line Link Icon */}
            <TouchableOpacity onPress={() => Linking.openURL('https://line.me/ti/p/~jsj1167b')}>
              <Image
            ...
            {/* Website Link Icon */}
            <TouchableOpacity onPress={() => Linking.openURL('https://www.cpslaboratory.com/')}>
              <Image
...
const styles = StyleSheet.create({
  ...
  mainCloseButton: { // Nama style yang lebih jelas
