...
export default function SettingsScreen() {
  ...
  const isScheduleOverlapping = (newSchedule: Omit<Schedule, "id">) => {
    ...
    if (newEndTime <= newStartTime) {
      Alert.alert("Invalid Time", "Off time must be after on time.");
      return true;
    }
  ...
  const handleChangeProfilePicture = async () => {
    ...
    if (!pickerResult.canceled) {
      ...
      Alert.alert(
        ...
        "Your new profile picture has been set!"
      );
    }
  };
  ...
  const handleSubmit = () => {
    if (isSubmitDisabled) {
      Alert.alert("Incomplete", "Please select a day and fill in the times.");
      return;
    }
    ...
    setSchedules((prevSchedules) =>
      [...prevSchedules, newSchedule].sort(
    ...
    Alert.alert("Delete Schedule", "Are you sure?", [
      { text: "Cancel", style: "cancel" },
      {
        ...
        onPress: () => {
          LayoutAnimation.configureNext(LayoutAnimation.Presets.easeInEaseOut);
          setSchedules((prevSchedules) =>
            prevSchedules.filter((s) => s.id !== idToDelete)
          );
        },
      },
    ]);
            ...
            <View style={styles.card}>
              <View style={styles.automaticCardContent}>
                ...
                <Text style={styles.automaticCardText}>
                  Automatic mode intelligently adjusts the lamp&apos;s
                  brightness and color based on sensor data and your
                  surroundings.
                </Text>
                <TouchableOpacity
                ...
                >
                  <Text style={styles.goToControlBtnText}>
                    Go to Lamp Controls
                  </Text>
                </TouchableOpacity>
              </View>
