    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.list}>
          <Text style={styles.listItem}>{'\u2022 Name and Contact Data: We collect your name and email address.'}</Text>
          <Text style={styles.listItem}>{'\u2022 Credentials: We collect passwords used for authentication and account access.'}</Text>
          <Text style={styles.listItem}>{"\u2022 Device and Connection Data: We collect your device's IP address and the SSID of the Wi-Fi network you connect."}</Text>
        </View>
        ...
        <View style={styles.list}>
          <Text style={styles.listItem}>{'\u2022 To facilitate account creation and the logon process.'}</Text>
          <Text style={styles.listItem}>{'\u2022 To manage user accounts and keep them in working order.'}</Text>
          <Text style={styles.listItem}>{"\u2022 To provide the core service of motion detection. This may require access to your device's camera feed, which is processed for motion and not stored unless motion is detected."}</Text>
          <Text style={styles.listItem}>{'\u2022 To send you administrative information, such as updates to our terms, conditions, and policies.'}</Text>
        </View>
